...
public final class HeaderView extends RelativeLayout {
    ...
    private void drawHeaderView() {
        final View view = LayoutInflater.from(getContext()).inflate(R.layout.boon_header_view, this, true);
    ...
    public HeaderView setNextButtonColor(int color) {
        nextButton.setColorFilter(Color.parseColor("#ffffff"), PorterDuff.Mode.SRC_ATOP);
        invalidate();
        return this;
    }
