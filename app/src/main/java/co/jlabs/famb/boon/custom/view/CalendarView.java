...
import co.jlabs.famb.boon.custom.internal.utils.CalendarUtils;

import static co.jlabs.famb.boon.custom.internal.utils.ScreenUtils.getScreenHeight;


/**
 * CalendarView class
 *
 * @author Kashyap Sharma
 */
public final class CalendarView extends LinearLayout {
    ...
    private void drawCalendar() {
        view = LayoutInflater.from(getContext()).inflate(R.layout.boon_material_calendar_view, this, true);
    ...
    public CalendarView setCalendarBackgroundColor(int calendarBackgroundColor) {
        this.calendarBackgroundColor = Color.parseColor("#ffffff");
        invalidate();
        return this;
    }
